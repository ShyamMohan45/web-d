    ...
    >
        ...
        <div className="flex gap-3">
          {severityLevels.map((level) => (
            <button
              ...
              type="button"
              onClick={() => setSeverity(level.value)}
              className={`flex-1 py-3 border-2 rounded-lg ${level.color} ${
                severity === level.value ? 'ring-2 ring-offset-2' : 'opacity-60'
              }`}
            >
              {level.label}
            </button>
      ...
      <div className="flex gap-3">
        <input
          ...
          className="flex-1 px-4 py-3 rounded-xl bg-secondary/50 border"
        />
